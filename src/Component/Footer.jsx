...
export default function Footer() {
    return (
        <footer>
            <img src={logo} alt="suite's logo" className="logo" />
            <p className="copy">Copyright - Suite </p>
            <div className="social">
                <a href="https://facebook.com" title="Suite's Facebook page" target="_black">
                ...
                <a href="https://twitter.com" title="Suite's Twitter page" target="_black">
                ...
                <a href="https://instagram.com" title="Suite's Instagram page" target="_black">
