    ...
    return (
        <figure className="quote">
            <picture className="quote__jeremy">
                ...
                <img srcSet={`${jeremy_mobile}, ${jeremy_mobile_2x} 2x`} alt="Jeremy" className="quote__img" />
            </picture>
            <img src={curved_line_2} aria-hidden="true" className="quote__decoration center" />
            <figcaption className="quote__text center">
